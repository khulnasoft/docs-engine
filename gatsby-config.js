...
const getProduct = name => {
  const repo = "@khulnasoft/brand-assets"
...
// TODO: Delete later on, This is to support some cases when the pathD is directly added in the docs-config manually in the product instead of getting the icon from the khulnasoft-brand-assets repo
if (docsConfig.productIconKey && !docsConfig.productLogoPathD) {
  docsConfig.productLogoPathD = productIcons.productIconKey
    ? productIcons[docsConfig.productIconKey]
    : ""
}

const siteMetadata = docsConfig.siteMetadata
siteMetadata.khulnasoftDocs = {}
Object.keys(docsConfig).forEach(prop => {
  if (prop === "siteMetadata") return
  siteMetadata.khulnasoftDocs[prop] = docsConfig[prop]
})

// TODO: Delete later on
siteMetadata.khulnasoftDocs.productIcons = productIcons
...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: "Khulnasoft docs",
        short_name: "Docs",
        start_url: "/",
        background_color: "#f38020",
        theme_color: "#f38020",
        display: "minimal-ui",
        icon: "src/images/khulnasoft-icon.png",
      },
    },
    ...
    // 'gatsby-plugin-offline',
    {
      ...
      options: {
        ...
        selfHostedOrigin: "https://tr.www.khulnasoft.com",
      },
    },
  ],
}
