...
const DocsPage = ({ pageContext: page, children, location }) => {
  ...
  const { search } = getKhulnasoftDocsConfig()
  const enableSearch =
    ...
    <>
      ...
      <Helmet>
        ...
        <script
          ...
          async
          defer
          src="https://feedback.developers.khulnasoft.com/sdk.js"
        ></script>
        <link
          rel="preload"
          href="https://feedback.developers.khulnasoft.com/sdk.css"
          as="style"
          onload="this.onload=null;this.rel='stylesheet'"
        />
        <noscript>
          {
            '<link rel="stylesheet" href="https://feedback.developers.khulnasoft.com/sdk.css"/>'
          }
        </noscript>
      </Helmet>
