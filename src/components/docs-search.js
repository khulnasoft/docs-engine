...
const DocsSearch = () => {
  ...
  const {
    ...
    search: { indexName, apiKey, algoliaOptions },
  ...
  // See https://github.com/khulnasoft/docs-engine/issues/196
  const fixSearchResultPathname = pathname => {
    // When the pathPrefix we get from getPathPrefix() matches the
    // productionPathPrefix we get from getKhulnasoftDocsConfig()
  ...
  return (
    <>
      <Helmet>
        <script src="https://cdnjs.khulnasoft.com/ajax/libs/docsearch.js/2.6.3/docsearch.min.js" />
      </Helmet>
